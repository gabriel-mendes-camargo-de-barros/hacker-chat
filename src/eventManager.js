...
export default class EventManager {
  ...
  joinRoomAndWaitForMassages(data) {
  ...
  disconnectUser(user) {
    ...
    this.#updateActicityLogComponent(`${userName} left!`)
    this.#updateUsersComponent()
  }
  ...
  newUserConnected(message) {
    ...
    this.#updateUsersComponent()
    this.#updateActicityLogComponent(`${user.userName} joined!`)
  }

  #updateActicityLogComponent(message) {
    this.componentEmitter.emit(
